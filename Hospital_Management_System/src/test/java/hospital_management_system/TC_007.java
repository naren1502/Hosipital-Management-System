...
public class TC_007 extends BaseClass_HMS{
	...
	public void enterAdminModule(String data[]){
		...
		js.executeScript("arguments[0].click();",admin.getSubmitButton());
		
		//getting the error message
		String actualErrorMessage = admin.getErrorMessageElement().getText();
		Assert.assertEquals(actualErrorMessage,data[11],"error message is mismatched");
		Reporter.log("entered doctor email is already exist", true);
