...
public class TC_014 extends BaseClass_HMS {

	@DataProvider
	public String[][] userData() {
		return ReadData.readDataExcel("testData",13);
	}
	...
	public void forpatientModule(String data[]){
		...
		String actualSuccessMsg = change.getOldPasswordMismatchMsg().getText().trim();
		Assert.assertEquals(actualSuccessMsg,data[8],"old password mismatch message is not displayed");
		Reporter.log("old password mismatch message is displayed",true);
