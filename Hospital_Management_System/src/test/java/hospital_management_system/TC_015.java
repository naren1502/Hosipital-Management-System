...
public class TC_015 extends BaseClass_HMS {

	@DataProvider
	public String[][] userData() {
		return ReadData.readDataExcel("testData",14);
	}
	...
	public void forpatientModule(String data[]){
		...
		alert.accept();
		Assert.assertEquals(actualErrorMsg,data[8],"confirm password is matched");
		Reporter.log("confirm password is not matched",true);
